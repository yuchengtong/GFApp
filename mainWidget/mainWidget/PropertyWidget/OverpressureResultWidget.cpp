...
OverpressureResultWidget::OverpressureResultWidget(QWidget* parent)
	:BasePropertyWidget(parent)
{
	initWidget();
}

void OverpressureResultWidget::initWidget()
{
	...
	QStringList labels = { "计算结果	","发动机壳体最大超压", "发动机壳体最小超压", "发动机壳体平均超压", "固体推进剂最大超压","发动机壳体超压标准差","固体推进剂最小超压","固体推进剂平均超压","固体推进剂超压标准差" ,
