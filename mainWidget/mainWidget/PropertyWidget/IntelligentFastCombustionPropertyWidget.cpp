...
IntelligentFastCombustionPropertyWidget::IntelligentFastCombustionPropertyWidget(QWidget* parent)
	:BasePropertyWidget(parent)
{
	initWidget();
}

void IntelligentFastCombustionPropertyWidget::initWidget()
{
	...
	QStringList labels = { "属性","智能分析对象","发动机壳体厚度最小值", "发动机壳体厚度最大值", "发动机壳体厚度设计水平", "快烤平均温度最小值","快烤平均温度最大值","快烤平均温度设计水平" };
	...
	QStringList valueLabels = { " ","快速烤燃试验","1", "3", "3", "600","800","3" };
