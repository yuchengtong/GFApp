...
IntelligentSacrificeExplosionPropertyWidget::IntelligentSacrificeExplosionPropertyWidget(QWidget* parent)
...
void IntelligentSacrificeExplosionPropertyWidget::initWidget()
{
	...
	QStringList labels = { "属性","智能分析对象","发动机壳体厚度最小值", "发动机壳体厚度最大值", "发动机壳体厚度设计水平", "殉爆距离最小值","殉爆距离最大值","殉爆距离设计水平" };
	...
	QStringList valueLabels = { " ","殉爆试验","1", "3", "5", "100","1000","5" };
