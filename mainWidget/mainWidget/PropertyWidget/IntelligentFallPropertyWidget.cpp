...
IntelligentFallPropertyWidget::IntelligentFallPropertyWidget(QWidget* parent)
	:BasePropertyWidget(parent)
{
	initWidget();
}

void IntelligentFallPropertyWidget::initWidget()
{
	...
	QStringList labels = { "属性","智能分析对象","发动机壳体厚度最小值", "发动机壳体厚度最大值", "发动机壳体厚度设计水平", "跌落高度最小值","跌落高度最大值","跌落高度设计水平" };
	...
	QStringList unitLabels = { " ","单位","mm", "mm", "等级", "m","m","等级" };
	...
	QStringList valueLabels = { " ","跌落试验","1", "3", "3", "10","30","3" };
