...
ReactionDegreeResultWidget::ReactionDegreeResultWidget(QWidget* parent)
...
void ReactionDegreeResultWidget::initWidget()
{
	...
	QStringList labels = { "计算结果	","固体推进剂最大反应度","固体推进剂最小反应度","固体推进剂平均反应度","固体推进剂反应度标准差" };
...
void ReactionDegreeResultWidget::updateData(double shellMaxValue, double shellMinValue, double shellAvgValue, double shellStandardValue, double maxValue, double minValue, double avgValue, double standardValue,
	double outheatMaxValue, double outheatMinValue, double outheatAvgValue, double outheatStandardValue, double insulatingheatMaxValue, double insulatingheatMinValue, double insulatingheatAvgValue, double insulatingheatStandardValue)
{
	...
	m_tableWidget->setItem(1, 2, maxValueItem);
	...
	m_tableWidget->setItem(2, 2, minValueItem);
	...
	m_tableWidget->setItem(3, 2, avgValueItem);
	...
	m_tableWidget->setItem(4, 2, standardValueItem);
