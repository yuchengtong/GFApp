...
IntelligentFragmentationImpactPropertyWidget::IntelligentFragmentationImpactPropertyWidget(QWidget* parent)
	:BasePropertyWidget(parent)
{
	initWidget();
}

void IntelligentFragmentationImpactPropertyWidget::initWidget()
{
	...
	QStringList unitLabels = { " ","单位","mm", "mm", "等级", "m/s","m/s","等级" };
	...
	QStringList valueLabels = { " ","破片撞击试验","1", "3", "3", "1630","1830","3" };
